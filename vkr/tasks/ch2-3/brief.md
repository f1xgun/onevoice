...
**Roadmap task:** Глава 2.3: Проектирование UI (структура, экранные формы, прототипы)

### Назначение
- Подготовить материалы для раздела `ch2-3` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
