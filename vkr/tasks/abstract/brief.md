...
**Roadmap task:** Написать/скорректировать АННОТАЦИЮ (до 600 знаков)

### Назначение
- Подготовить материалы для раздела `abstract` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
