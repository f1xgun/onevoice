...
**Roadmap task:** Глава 3.4: Вопросы информационной безопасности и лицензирования

### Назначение
- Подготовить материалы для раздела `ch3-4` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
