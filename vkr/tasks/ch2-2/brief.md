...
**Roadmap task:** Глава 2.2: Проектирование БД (ER-диаграмма, даталогическая модель, SQL-запросы)

### Назначение
- Подготовить материалы для раздела `ch2-2` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
