...
**Roadmap task:** Глава 1.1: Описание предметной области и проблем управления цифровым присутствием МСБ

### Назначение
- Подготовить материалы для раздела `ch1-1` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
