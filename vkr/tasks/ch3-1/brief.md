...
**Roadmap task:** Глава 3.1: Тестирование системы на примере типового бизнеса

### Назначение
- Подготовить материалы для раздела `ch3-1` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
