...
**Roadmap task:** Глава 2.5: Инструкция по установке и настройке системы

### Назначение
- Подготовить материалы для раздела `ch2-5` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
