...
**Roadmap task:** Глава 2.1: Проектирование архитектуры МАС (оркестратор, специализированные агенты)

### Назначение
- Подготовить материалы для раздела `ch2-1` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
