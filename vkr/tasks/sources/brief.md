...
**Roadmap task:** Собрать список источников (минимум 50, 5% иностранных, по ГОСТ Р 7.0.100-2018)

### Назначение
- Подготовить материалы для раздела `sources` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
