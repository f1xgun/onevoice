...
**Roadmap task:** Глава 1.4: Сравнительный анализ аналогов (Bitrix24, Hootsuite, ORM-системы)

### Назначение
- Подготовить материалы для раздела `ch1-4` в формате, удобном для фактчекинга и последующей сборки в `vkr/draft/draft.md`.
