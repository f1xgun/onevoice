...
// handler's 400 body (never silently ignore).
...
// same semantics for HITL edit enforcement — case-sensitivity
// cannot diverge between orchestrator and API.
//
// ValidateEditArgs was originally defined in this file; it now delegates to
// pkg/toolvalidation. See pkg/toolvalidation/validate.go for the full contract.
