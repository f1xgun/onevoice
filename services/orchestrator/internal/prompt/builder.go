...
func buildPlatformBlockRu() string {
	...
	sb.WriteString("- Перед вызовом инструмента убеди­сь, что соответствующая интеграция активна в текущем бизнес-контексте. Если интеграции нет — объясни ограничение и предложи альтернативу из активных каналов вместо молчаливой подмены.\n")
