...
export interface AlertDialogActionProps extends ComponentPropsWithoutRef<typeof Action> {
  variant?: ButtonProps['variant'];
}

export interface AlertDialogCancelProps extends ComponentPropsWithoutRef<typeof Cancel> {
  className?: string;
}
...
export const AlertDialogAction = forwardRef<ElementRef<typeof Action>, AlertDialogActionProps>(
...
export const AlertDialogCancel = forwardRef<ElementRef<typeof Cancel>, AlertDialogCancelProps>(
