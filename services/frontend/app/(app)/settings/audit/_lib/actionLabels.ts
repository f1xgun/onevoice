...
export const ACTION_LABEL_KEYS: Record<AuditAction, string> = {
  ...
  'integration.token_expired': 'audit.actions.integration_token_expired',
  'integration.metadata_updated': 'audit.actions.integration_metadata_updated',
  'integration.external_id_updated': 'audit.actions.integration_external_id_updated',
