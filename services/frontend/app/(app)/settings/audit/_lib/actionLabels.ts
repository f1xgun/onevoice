...
export const ACTION_LABEL_KEYS: Record<AuditAction, string> = {
  ...
  'auth.password_reset_requested': 'audit.actions.auth_password_reset_requested',
  'auth.password_reset_completed': 'audit.actions.auth_password_reset_completed',
  'auth.password_reset_request_unknown_email':
    'audit.actions.auth_password_reset_request_unknown_email',
  'auth.email_verification_link_viewed': 'audit.actions.auth_email_verification_link_viewed',
  'auth.email_verified': 'audit.actions.auth_email_verified',
  'auth.email_changed_before_verify': 'audit.actions.auth_email_changed_before_verify',
  'auth.consent_recorded': 'audit.actions.auth_consent_recorded',
  'auth.consent_reconsent_required': 'audit.actions.auth_consent_reconsent_required',
  'auth.consent_reconsented': 'audit.actions.auth_consent_reconsented',
  'auth.consent_withdrawn': 'audit.actions.auth_consent_withdrawn',
  'auth.consent_policy_version_bumped': 'audit.actions.auth_consent_policy_version_bumped',
  'account.deletion_requested': 'audit.actions.account_deletion_requested',
  'account.deletion_canceled': 'audit.actions.account_deletion_canceled',
  'account.sole_owner_blocked': 'audit.actions.account_sole_owner_blocked',
  'account.user_self_deleted': 'audit.actions.account_user_self_deleted',
