module github.com/f1xgun/onevoice/services/api
...
replace github.com/f1xgun/onevoice/pkg/email => ../../pkg/email
...
require (
	...
	github.com/f1xgun/onevoice/pkg/email v0.0.0-00010101000000-000000000000
