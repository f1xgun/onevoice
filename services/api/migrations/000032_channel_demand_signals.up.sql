...
--
-- business_id is NOT NULL and ON DELETE CASCADE: a demand signal is meaningless
-- without its business and the endpoint is always business-scoped, so a business
-- hard-delete transitively erases its signals.
