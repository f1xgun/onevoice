...
func TestChatProxy_EnrichesContext(t *testing.T) {
	...
	h := NewChatProxyHandler(mockBiz, mockInteg, &MockMessageRepository{}, orchServer.URL, nil)
...
func TestChatProxy_NoBusiness(t *testing.T) {
	...
	h := NewChatProxyHandler(mockBiz, mockInteg, &MockMessageRepository{}, "http://unused", nil)
...
func TestChatProxy_OrchestratorDown(t *testing.T) {
	...
	h := NewChatProxyHandler(mockBiz, mockInteg, &MockMessageRepository{}, "http://127.0.0.1:1", nil)
