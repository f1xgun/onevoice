...
func TestChatProxy_EnrichesContext(t *testing.T) {
	...
	h := NewChatProxyHandler(mockBiz, mockInteg, &MockMessageRepository{}, nil, nil, nil, nil, orchServer.URL, nil)
...
func TestChatProxy_NoBusiness(t *testing.T) {
	...
	h := NewChatProxyHandler(mockBiz, mockInteg, &MockMessageRepository{}, nil, nil, nil, nil, "http://unused", nil)
...
func TestChatProxy_OrchestratorDown(t *testing.T) {
	...
	h := NewChatProxyHandler(mockBiz, mockInteg, &MockMessageRepository{}, nil, nil, nil, nil, "http://127.0.0.1:1", nil)
