...
--
-- Production path: uses gen_random_uuid (matches migrations/postgres/000001_init.up.sql).
-- Integration-test mirror lives at services/api/migrations/000005_rbac_data_model.up.sql
-- and uses uuid_generate_v4 — same logical schema, different UUID idiom per
