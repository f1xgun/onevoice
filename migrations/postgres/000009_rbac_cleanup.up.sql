-- Renumbered from 000008 to 000009 in to resolve duplicate-version collision with 000008_audit_log_infrastructure.
-- v2.0 RBAC cleanup: drop legacy single-owner-per-business artifacts.
-- (migration 000007) seeded business_members; every business now has
...
-- per-business role lives in business_members.role_id (DATA-02).
