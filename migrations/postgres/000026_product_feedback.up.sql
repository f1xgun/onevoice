...
-- (bug / idea / question / other), optionally with a 1-5 rating for
-- Sean-Ellis / NPS-style measurement. user_id + business_id are nullable and
-- ON DELETE SET NULL so feedback survives account/org deletion for product
-- learning while never holding a dangling FK.
