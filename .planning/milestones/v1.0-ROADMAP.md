...
- [x] PLAN-4.3: Implement get_reviews and reply_review RPA tools (YBZ-01, YBZ-02) — gated on PLAN-4.0
...
### Plans
- [x] PLAN-5.1: Health check endpoints for all services — /health/live and /health/ready (OBS-01)
