...
- [x] **Phase 19: Search & Sidebar Redesign** — Mongo $text search (Russian stemming) and master/detail sidebar with pinned chats (completed 2026-04-27)
...
- [x] 19-05-a11y-and-audit-PLAN.md — Wave 3: @chialab/vitest-axe install + useRovingTabIndex + mobile auto-close + axe CI gate on critical+serious wired into make test-all (UI-04, UI-05)
