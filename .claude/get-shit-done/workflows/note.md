...
- **Global scope**: `/Users/f1xgun/onevoice/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/f1xgun/onevoice/.claude/notes/`)
...
2. Glob `/Users/f1xgun/onevoice/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/f1xgun/onevoice/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/f1xgun/onevoice/.claude/notes/` — works in any directory
