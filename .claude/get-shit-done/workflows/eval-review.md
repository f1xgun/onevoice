...
```bash
AUDITOR_MODEL=$(node "/Users/f1xgun/onevoice/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/f1xgun/onevoice/.claude/agents/gsd-eval-auditor.md for instructions.
