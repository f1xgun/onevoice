...
```bash
cp "/Users/f1xgun/onevoice/.claude/get-shit-done/USER-PROFILE.md" "/Users/f1xgun/onevoice/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/f1xgun/onevoice/.claude/USER-PROFILE.backup.md"
```
