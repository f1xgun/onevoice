...
overview: Детальный план-roadmap для оформления пояснительной записки к ВКР на тему "Разработка программного комплекса на основе мультиагентной архитектуры с гибридной моделью интеграции для управления цифровым присутствием МСБ". План включает структуру документа, задачи для каждого раздела и правила для агентов.
todos:
  - id: intro
...
**Тема ВКР:** Разработка программного комплекса на основе мультиагентной архитектуры с гибридной моделью интеграции для управления цифровым присутствием субъектов малого и среднего бизнеса
...
- [ ] Спроектировать специализированных агентов: API-агенты (VK, Telegram) и RPA-агенты (Яндекс.Бизнес, 2ГИС)
